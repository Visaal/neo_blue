local c = require("neo_blue.palette")
...
theme.set_highlights = function()
	...
	hl(0, "@variable.parameter", { fg = c.pink, bg = "NONE" })
	hl(0, "@variable.member", { fg = c.base08, bg = "NONE" })
	...
	hl(0, "@punctuation.delimiter", { fg = c.base08, bg = "NONE" })
	...
	-- NeoTree
	hl(0, "NeoTreeNormal", { bg = c.darker_black, fg = "NONE" })
	hl(0, "NeoTreeNormalNC", { bg = c.darker_black, fg = "NONE" })
	hl(0, "NeoTreeCursorLine", { bg = c.black, fg = "NONE", bold = true })
	hl(0, "NeoTreeDirectoryIcon", { fg = c.sun, bg = "NONE" })
	hl(0, "NeoTreeDirectoryName", { fg = c.grey, bg = "NONE" })
	hl(0, "NeoTreeIndentMarker", { fg = c.grey, bg = "NONE" })
	hl(0, "NeoTreeGitAdded", { fg = c.vibrant_green, bg = "NONE" })
	hl(0, "NeoTreeGitUntracked", { fg = c.base0B, bg = "NONE" })

	-- hl(0, "NeoTreeIndentMarker", { fg = "#c5c5c5", bg = "NONE" })
	-- hl(0, "NeoTreeNormal", { fg = "NONE", bg = c.darker_black })
	-- hl(0, "NeoTreeVertSplit", { fg = c.darker_black, bg = c.darker_black })
	-- hl(0, "NeoTreeFolderName", { fg = c.blue, bg = "NONE" })
	-- hl(0, "NeoTreeOpenedFolderName", { fg = c.blue, bg = "NONE", bold = true, italic = true })
	-- hl(0, "NeoTreeEmptyFolderName", { fg = c.grey, bg = "NONE", italic = true })
	-- hl(0, "NeoTreeGitIgnored", { fg = c.grey, bg = "NONE", italic = true })
	-- hl(0, "NeoTreeImageFile", { fg = c.light_grey, bg = "NONE" })
	-- hl(0, "NeoTreeSpecialFile", { fg = c.orange, bg = "NONE" })
	-- hl(0, "NeoTreeEndOfBuffer", { fg = c.darker_black, bg = "NONE" })
	-- hl(0, "NeoTreeCursorLine", { fg = "NONE", bg = "#282b37" })
	-- hl(0, "NeoTreeGitignoreIcon", { fg = c.red, bg = "NONE" })
	-- hl(0, "NeoTreeGitStaged", { fg = c.vibrant_green, bg = "NONE" })
	-- hl(0, "NeoTreeGitNew", { fg = c.vibrant_green, bg = "NONE" })
	-- hl(0, "NeoTreeGitRenamed", { fg = c.vibrant_green, bg = "NONE" })
	-- hl(0, "NeoTreeGitDeleted", { fg = c.red, bg = "NONE" })
	-- hl(0, "NeoTreeGitMerge", { fg = c.blue, bg = "NONE" })
	-- hl(0, "NeoTreeGitDirty", { fg = c.blue, bg = "NONE" })
	-- hl(0, "NeoTreeSymlink", { fg = c.cyan, bg = "NONE" })
	-- hl(0, "NeoTreeRootFolder", { fg = c.base05, bg = "NONE", bold = true })
	-- hl(0, "NeoTreeExecFile", { fg = c.green, bg = "NONE" })
